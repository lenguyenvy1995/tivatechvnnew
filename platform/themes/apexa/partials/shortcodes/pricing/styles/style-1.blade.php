<section class="pricing__area p-0 pricing__bg shortcode-pricing shortcode-pricing-style1" @style($variablesStyle)>
    <div class="tiva-shape tiva-shape-top">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 100" preserveAspectRatio="none" fill="#FFFFFF" preserveAspectRatio="none"
                    ...
                    <div @class($itemWrapperClass)>
                        <div class="pricing__box pricing__box_{{ $loop->iteration }}" data-aos="fade-left"
                            ...
                            <div class="pricing__price">
                                <h4 class="price monthly_price"> {{ $package->price }}<span>/
                                        {{ $package->duration->label() }}</span></h4>
                                <h4 class="price annual_price">{{ $package->annual_price }} <span>/
                                        {{ __('Yearly') }}</span></h4>
                            </div>

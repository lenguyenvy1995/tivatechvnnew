<section class="py-4 py-md-5 about__area-four shortcode-about-us-information shortcode-about-us-information-style-11"
    @style($variablesStyle)>
    <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-6 col-md-9 col-sm-10">
                <div class="about__img-wrap-four " data-aos="fade-down-right" data-aos-duration="2000">
                    ...
                    @endif
                    @if ($author_name = $shortcode->author_name)
                        <div class="ceo_name">
                            <h3 class="title-ceo_name">{{ $author_name }}</h3>
            ...
            <div class="col-lg-6">
                <div class="about__content-four">
                    ...
                    @if ($description = $shortcode->description)
                        <p style="text-align: justify;" class="mb-0">{!! BaseHelper::clean($description) !!}</p>
                    @endif

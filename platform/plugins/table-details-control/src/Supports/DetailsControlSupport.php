...
class DetailsControlSupport
{
        ...
        switch ($field->getType()) {
            ...
            case ('editor'):
                $html = Html::tag('div', BaseHelper::clean($value), [
                    'class' => 'editor-content p-2 border rounded overflow-auto',
    ...
    public static function createForm($form, BaseModel $model)
    {
        $form = $form::createFromModel($model);
        Closure::bind(fn ($class) => $class->dispatchBeforeRendering(), null, get_class($form))($form);
